...
class SecureStorage:
    ...
    def generate_storage_path(self, document_id: UUID, encrypted: bool = True) -> Path:
        """
        ...
        """
        # Use first two characters of UUID for directory structure
        uuid_str = str(document_id).replace('-', '')
        subdir = uuid_str[:2]
    ...
    def generate_metadata_path(self, document_id: UUID) -> Path:
        """
    ...
    async def store_document(self, content: bytes, document_id: UUID, 
                           encrypt: bool = True, 
    ...
    async def retrieve_document(self, document_id: UUID, 
    ...
    async def move_temp_to_storage(self, temp_path: str, document_id: UUID,
                                 encrypt: bool = True,
                                 password: Optional[str] = None) -> Dict[str, Any]:
        """

...
class ProgressTracker:
    ...
    def __init__(self):
        ...
        self._progress_info: Dict[UUID, ProgressInfo] = {}
        self._callbacks: Dict[UUID, list] = {}
    ...
    async def create_progress(self, filename: str, total_size: int, 
        ...
        Returns:
            UUID of the created progress tracker
        """
    ...
    async def start_progress(self, progress_id: UUID) -> None:
        """
    ...
    async def update_progress(self, progress_id: UUID, processed_size: int) -> None:
        """
    ...
    async def complete_progress(self, progress_id: UUID) -> None:
        """
    ...
    async def fail_progress(self, progress_id: UUID, error_message: str) -> None:
        """
    ...
    async def cancel_progress(self, progress_id: UUID) -> None:
        """
    ...
    async def get_progress(self, progress_id: UUID) -> Optional[ProgressInfo]:
        """
    ...
    async def get_all_progress(self) -> Dict[UUID, ProgressInfo]:
        """
    ...
    async def add_callback(self, progress_id: UUID, 
    ...
    async def remove_callback(self, progress_id: UUID, 
                            callback: Callable[[ProgressInfo], None]) -> None:
        """
    ...
    async def _notify_callbacks(self, progress_id: UUID, progress: ProgressInfo) -> None:
        """
...
class BatchProgressTracker:
    ...
    def __init__(self):
        ...
        self._batch_progress: Dict[UUID, Dict[str, Any]] = {}
        self._file_progress: Dict[UUID, Dict[UUID, ProgressInfo]] = {}
        self._lock = asyncio.Lock()
    
    async def create_batch(self, batch_id: UUID, total_files: int) -> None:
        """
    ...
    async def add_file_to_batch(self, batch_id: UUID, file_progress_id: UUID, 
        ...
        Args:
            batch_id: UUID of the batch
            file_progress_id: UUID of the file progress
    ...
    async def update_batch_progress(self, batch_id: UUID) -> None:
        """
    ...
    async def get_batch_progress(self, batch_id: UUID) -> Optional[Dict[str, Any]]:
        """
    ...
    async def get_batch_file_progress(self, batch_id: UUID) -> Dict[UUID, ProgressInfo]:
        """
